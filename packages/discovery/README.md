...
Current support is Next.js App Router 15.3 or newer with TypeScript or JavaScript source. Symbolic links are not followed. Build outputs, dependencies, environment files, and likely credential files are excluded.
