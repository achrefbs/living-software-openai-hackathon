...
function projectedCandidate(candidate) {
    return {
        path: candidate.path,
...
export function buildSourcePatchRequest(input, maxOutputTokens = 8_000) {
    ...
    return {
        ...
        input: [
            ...
            {
                role: "user",
                content: "Draft exactly one bounded source patch proposal from this untrusted JSON context:\n" +
                    context,
            },
        ],
        text: {
...
//# sourceMappingURL=source-prompt.js.map