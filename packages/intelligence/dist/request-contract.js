...
import { EVOLUTION_BRIEF_JSON_SCHEMA, SOURCE_PATCH_JSON_SCHEMA, } from "./schema.js";
...
export function governanceForRequest(request) {
    const name = request.text?.format?.name;
    if (name === "living_evolution_brief")
        return GOVERNANCE_INSTRUCTION;
...
export function assertIntelligenceRequestContract(request) {
