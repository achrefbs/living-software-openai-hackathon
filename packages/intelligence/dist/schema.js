...
const PATCH_TEXT_ZOD_PATTERN = /^[^\u0000-\u0008\u000B\u000C\u000E-\u001F\u007F-\u009F\u00A0\u1680\u2000-\u200A\u2028\u2029\u202F\u205F\u3000\uFEFF]*$/u;
...
export const modelEvolutionBriefSchema = z.object({
    ...
    const citedMetricNames = new Set(brief.evidenceCitations.metrics.map((metric) => metric.name));
            ...
            items: {
                ...
                properties: {
                    ...
                    replacement: {
                        ...
                        pattern: PATCH_TEXT_JSON_PATTERN,
                        description: "Complete syntactically valid final source fragment; never truncated, padded, or placeholder text.",
                    },
                },
            },
        },
