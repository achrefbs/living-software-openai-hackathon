...
import { productManifestSchema, sourceReferenceSchema, } from "./product-manifest.js";
import { eventNameSchema, identifierSchema, relativePathSchema, sha256Schema, } from "./primitives.js";
...
export function parseDiscoveryResult(input) {
