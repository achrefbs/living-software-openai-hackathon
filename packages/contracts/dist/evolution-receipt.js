import { z } from "zod";
import { identifierSchema, isoDateTimeSchema, jsonObjectSchema, sha256Schema, } from "./primitives.js";
...
export const evolutionReceiptSchema = z
    ...
    if ((receipt.kind === "contract.confirmed" ||
    ...
    if ((receipt.kind === "hypothesis.created" ||
    ...
    if (receipt.kind === "artifact.compiled" &&
...
export function parseEvolutionReceipt(input) {
    return evolutionReceiptSchema.parse(input);
}
//# sourceMappingURL=evolution-receipt.js.map