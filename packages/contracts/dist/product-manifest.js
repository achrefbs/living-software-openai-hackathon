import { z } from "zod";
import { identifierSchema, isoDateTimeSchema, jsonObjectSchema, relativePathSchema, sha256Schema, } from "./primitives.js";
...
export const hostInterfaceDescriptorSchema = z
    ...
    const operationKeys = descriptor.operations.map((operation) => `${operation.id}@${operation.version}`);
...
export function parseProductManifest(input) {
    return productManifestSchema.parse(input);
}
//# sourceMappingURL=product-manifest.js.map