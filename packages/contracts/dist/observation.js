...
import { eventNameSchema, identifierSchema, sha256Schema, } from "./primitives.js";
const routePatternSchema = z
    ...
    pattern
        ...
        segment === "*"), { message: "Route patterns must contain only safe literal or dynamic segments" });
...
export function parseObservationRuntimeMap(input) {
