import { z } from "zod";
import { contentRefSchema, eventNameSchema, identifierSchema, isoDateTimeSchema, sha256Schema, } from "./primitives.js";
export const opportunitySchema = z
    ...
    if (new Set(opportunity.evidence.sampleEventIds).size !==
...
export function parseOpportunity(input) {
