...
export const studioCommandEnvelopeSchema = z
  ...
  .superRefine((envelope, context) => {
    if (
      envelope.command.type === "contract.confirm" &&
...
export type StudioCommandEnvelope = z.infer<
  typeof studioCommandEnvelopeSchema
>;

export function parseStudioCommandEnvelope(
  input: unknown,
...
export function parseStudioCommandResult(input: unknown): StudioCommandResult {
